package cl.duoc.proveedores.config;
...
/**
 * Configuracion central de OpenAPI/Swagger para el microservicio Proveedores.
 *
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                ...
                .description("Microservicio Proveedores - Proyecto Cafeteria (DSY1103)")
                .version("v1"))
