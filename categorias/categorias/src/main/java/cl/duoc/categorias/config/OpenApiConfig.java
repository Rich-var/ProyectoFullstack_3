package cl.duoc.categorias.config;
...
/**
 * Configuracion central de OpenAPI/Swagger para el microservicio Categorias.
 *
...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                .title("Categorias Service API")
                .description("Microservicio Categorias - Proyecto Cafeteria (DSY1103)")
                .version("v1"))
