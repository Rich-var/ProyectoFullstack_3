package cl.duoc.sucursales.config;
...
/**
 * Configuracion central de OpenAPI/Swagger para el microservicio Sucursales.
 *
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                ...
                .description("Microservicio Sucursales - Proyecto Cafeteria (DSY1103)")
                .version("v1"))
